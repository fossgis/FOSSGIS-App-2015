    ...
    $(document).ready(function(){
        ...
        $("#answerform").submit(function(event){
            $.post('../backend/NoticeBoard/nb_ret_insertcomment.php', $(this).serialize(),function(data) {
                $("#commentInsert").html("<div class='row'><div id='actionlink' align='center' class='large-12 columns'><a href='#fndtn-schwarzesBrett' class='button expand' onclick='ShowAnswerForm(0)' style='font-weight: bold'>Notiz erstellen</a></div></div><div class='row'><div class='large-12 columns'><p>Die Notiz wurde erfolgreich hinzugef&uuml;gt.</p></div></div>");
				DisplayComments();
            });
